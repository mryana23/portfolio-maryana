...
const projectPreviews = [
  {
    id: 1,
    title: "RF Test Indonesia",
    subtitle: "Corporate Website",
    period: "August 2025",
    tech: ["Laravel", "React", "MySQL", "Pusher", "HTML+CSS+JS"],
    role: "Fullstack Developer",
    link: "https://rf-test-indonesia.co.id",
    gradient: "135deg, #0ea5e9, #6366f1",
  ...
  {
    id: 2,
    title: "Rigol Indonesia",
    subtitle: "Corporate Website",
    period: "September 2025",
    tech: ["Laravel", "MySQL", "HTML+CSS+JS", "Pusher"],
    role: "Fullstack Developer",
  ...
  {
    id: 3,
    title: "Unitronic Jaya",
    subtitle: "Corporate Website",
    period: "October 2025",
    tech: ["Laravel", "MySQL", "HTML+CSS+JS", "Pusher"],
    role: "Fullstack Developer",
    link: "https://unitronicjaya.com/",
    gradient: "135deg, #f59e0b, #f97316",
  ...
  {
    id: 4,
    title: "Extracurricular Mgmt",
    subtitle: "School Management App",
    period: "Aug–Nov 2024",
    tech: ["Laravel", "MySQL", "HTML+CSS+JS"],
  ...
  },
  {
    ...
    tech: ["Laravel", "MySQL", "Midtrans API", "HTML+CSS+JS"],
    role: "Fullstack Developer",
    link: null,
  ...
  },
  {
    ...
    period: "Jan–Mar 2025",
    tech: ["Django", "MariaDB", "REST API", "Python"],
    role: "Backend Developer",
    link: null,
    gradient: "135deg, #6366f1, #a855f7",
    glow: "rgba(99,102,241,0.5)",
    image: artefy,
  ...
  },
  {
    id: 7,
    title: "NexaTech",
    subtitle: "Dummy Company Profile Website",
    period: "October 2025",
    tech: ["React", "Tailwind CSS", "Vite"],
    role: "Frontend Developer",
    link: "https://nexa-tech-virid.vercel.app/",
    gradient: "135deg, #22c55e, #06b6d4",
  ...
  {
    id: 8,
    title: "Sumber Instrumindo",
    subtitle: "Corporate Website",
    period: "September 2024",
    tech: ["Laravel", "MySQL", "Bootstrap", "HTML+CSS+JS"],
    role: "Fullstack Developer",
    link: "https://sumberinstrumindo.com/",
    gradient: "135deg, #f97316, #ef4444",
    glow: "rgba(249,115,22,0.5)",
    image: sumber,
...
export default function Portfolio() {
  ...
  useEffect(() => {
    const k = (e) => {
      ...
      if (e.key === "ArrowRight")
        setActivePreview((i) => (i + 1) % projectPreviews.length);
      if (e.key === "ArrowLeft")
        setActivePreview(
          (i) => (i - 1 + projectPreviews.length) % projectPreviews.length,
        );
    };
  ...
  const projects = [
    {
      ...
      period: "October 2025",
      description:
        "Dummy company profile website for NexaTech, a digital solution agency. Showcases services, pricing plans, testimonials, and a modern landing page focused on clean UI and conversion-oriented design.",
      tech: ["React", "Tailwind CSS", "Vite"],
      role: "Frontend Developer",
      icon: Sparkles,
      accent: "#22c55e",
    ...
    },
    {
      ...
      description:
        "Community-driven platform for local artists built during internship. Features community profiles, event listings, and discussion forums. Django backend with REST API development.",
      tech: ["Django", "Nuxt.js (Exposure)", "MariaDB", "REST API", "Python"],
      role: "Backend Developer",
      icon: Palette,
      accent: "#818cf8",
    },
    {
      ...
      period: "August 2025",
      description:
        "Corporate website with React V1 later rebuilt as full Laravel stack. Features product catalog, admin panel, responsive design, live chat via Pusher, WhatsApp integration for customer inquiries and form to email integration.",
      tech: ["React", "Laravel", "MySQL", "REST API", "Pusher"],
      role: "Fullstack Developer",
      icon: Laptop,
      accent: "#22d3ee",
      link: "https://rf-test-indonesia.co.id",
    },
    {
      ...
      period: "September 2024",
      description:
        "Professional corporate website with product catalog, CMS powered by MySQL, admin dashboard, responsive layout, email contact form and WhatsApp integration for customer inquiries.",
      tech: ["Laravel", "MySQL", "Bootstrap", "HTML+CSS+JS"],
      role: "Fullstack Developer",
      icon: Boxes,
      accent: "#fb923c",
    ...
    },
    {
      ...
      period: "September 2025",
      description:
        "Corporate website with product catalog, company information, CMS, admin panel, responsive design, WhatsApp integration for customer inquiries, form to email integration and live chat via Pusher.",
      tech: ["Laravel", "MySQL", "HTML+CSS+JS", "Pusher"],
      role: "Fullstack Developer",
      icon: BarChart3,
      accent: "#10b981",
    ...
    },
    {
      ...
      period: "October 2025",
      description:
        "Corporate website with product catalog, CMS, admin panel, responsive design, live chat via Pusher, WhatsApp integration for customer inquiries, and email contact form.",
      tech: ["Laravel", "MySQL", "HTML+CSS+JS", "Pusher"],
      role: "Fullstack Developer",
      icon: Globe2,
      accent: "#f59e0b",
  ...
  return (
    ...
    >
      <link
        href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,600;1,700;1,800;1,900&family=DM+Mono:wght@400;500&display=swap"
        rel="stylesheet"
      />
      <style>{`
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(99,102,241,.14) 0%,transparent 68%)",
            filter: "blur(50px)",
          }}
        />
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(6,182,212,.11) 0%,transparent 68%)",
            filter: "blur(50px)",
            animationDelay: "8s",
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(168,85,247,.09) 0%,transparent 68%)",
            filter: "blur(50px)",
            animationDelay: "15s",
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(124,58,237,.05) 0%,transparent 70%)",
            filter: "blur(70px)",
            transform: `translate(${mouse.x * window.innerWidth - 350}px,${mouse.y * window.innerHeight - 350}px)`,
      ...
      <nav
        style={{
          ...
          borderBottom:
            scrollY > 60
              ? `1px solid ${D ? "rgba(99,102,241,.1)" : "rgba(99,102,241,.15)"}`
              : "none",
        }}
      >
        <div
        ...
        >
          ...
          >
            ...
            <span style={{ fontWeight: 700, fontSize: "17px", color: T.text }}>
              Maryana's Portfolio
            </span>
          </button>
          ...
          >
            {["Home", "About", "Experience", "Projects", "Contact"].map(
              (item) => (
                <button
                  key={item}
                  className={`nav-btn${activeSection === item.toLowerCase() ? " act" : ""}`}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <button
              ...
              style={{
                ...
                height: "38px",
                borderRadius: "11px",
                background: D ? "rgba(99,102,241,.1)" : "rgba(99,102,241,.1)",
                border: `1px solid ${D ? "rgba(99,102,241,.22)" : "rgba(99,102,241,.22)"}`,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                cursor: "pointer",
        ...
        {isMenuOpen && (
          <div
            style={{
              background: D ? "rgba(4,6,13,.97)" : "rgba(238,234,255,.98)",
              backdropFilter: "blur(20px)",
              borderTop: `1px solid ${D ? "rgba(99,102,241,.1)" : "rgba(99,102,241,.15)"}`,
              ...
              (item) => (
                <button
                  ...
                  style={{
                    ...
                    borderBottom: `1px solid ${D ? "rgba(99,102,241,.07)" : "rgba(99,102,241,.1)"}`,
                  }}
                >
                  {item}
                </button>
        ...
        {[650, 450, 260].map((size, i) => (
          <div
            ...
            style={{
              ...
              height: `${size}px`,
              borderRadius: "50%",
              border: `1px solid ${D ? "rgba(99,102,241,.07)" : "rgba(99,102,241,.1)"}`,
              pointerEvents: "none",
              animation: `ringPulse ${6 + i * 1.5}s ease-in-out ${i * 0.8}s infinite`,
            }}
          />
        ))}
        ...
        >
          ...
          <div
            style={{
              ...
              padding: "7px 18px",
              borderRadius: "999px",
              background: D ? "rgba(34,197,94,.07)" : "rgba(34,197,94,.1)",
              border: "1px solid rgba(34,197,94,.22)",
              marginBottom: "44px",
              animation:
                "fadeUp .9s cubic-bezier(.22,1,.36,1) both, badgePop .6s cubic-bezier(.22,1,.36,1) .2s both",
            }}
          >
            <div className="dot-pulse" style={{ background: "#7c807eff" }} />
            <span
              className="mono lbl"
              style={{ color: T.textSub, fontSize: "10px" }}
            >
          ...
          >
            ...
            <div
              style={{
                minHeight: "clamp(50px,9vw,104px)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                marginBottom: "8px",
            ...
            >
              ...
              >
                <span
                  style={{
                    background:
                      "linear-gradient(130deg,#a5b4fc 0%,#c084fc 35%,#22d3ee 75%,#67e8f9 100%)",
            ...
            >
              <div
                style={{
                  ...
                  width: "80px",
                  background: D
                    ? "linear-gradient(90deg,transparent,rgba(99,102,241,.4))"
                    : "linear-gradient(90deg,transparent,rgba(99,102,241,.35))",
                }}
              />
              <span
                style={{
              ...
              <div
                style={{
                  ...
                  width: "80px",
                  background: D
                    ? "linear-gradient(90deg,rgba(99,102,241,.4),transparent)"
                    : "linear-gradient(90deg,rgba(99,102,241,.35),transparent)",
                }}
              />
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              web applications with clean code and beautiful design
            </p>
            <div
              style={{
                display: "inline-flex",
                ...
                background: D
                  ? "rgba(255,255,255,.03)"
                  : "rgba(99,102,241,.07)",
                border: `1px solid ${D ? "rgba(255,255,255,.06)" : "rgba(99,102,241,.15)"}`,
                marginBottom: "42px",
              }}
            >
              ...
              <span
                className="mono lbl"
                style={{ color: T.textMuted, fontSize: "9px" }}
              >
                Core Stack:
              </span>
              <span
                className="mono lbl"
                style={{ color: D ? "#a5b4fc" : "#4f46e5", fontSize: "9px" }}
              >
          ...
          <div
            style={{
              ...
              flexWrap: "wrap",
              marginBottom: "80px",
              animation: "fadeUp .9s cubic-bezier(.22,1,.36,1) .4s both",
            }}
          >
            <button
              ...
              style={{
                ...
                textTransform: "uppercase",
                boxShadow:
                  "0 8px 32px rgba(124,58,237,.38),inset 0 1px 0 rgba(255,255,255,.15)",
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                background: D
                  ? "rgba(255,255,255,.04)"
                  : "rgba(99,102,241,.08)",
                border: `1px solid ${D ? "rgba(255,255,255,.11)" : "rgba(99,102,241,.22)"}`,
                color: T.text,
                fontSize: "13px",
                fontWeight: 700,
                cursor: "pointer",
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  textAlign: "center",
                  boxShadow: D
                    ? "0 4px 28px rgba(0,0,0,.35),inset 0 1px 0 rgba(255,255,255,.04)"
                    : "0 4px 28px rgba(99,102,241,.1),inset 0 1px 0 rgba(255,255,255,.9)",
                }}
              >
                <div
                  className="icon-spin"
                ...
                <div
                  className="mono lbl"
                  style={{ color: T.textFaint, fontSize: "8.5px" }}
                >
                  {s.label}
                </div>
              </div>
      ...
      <section
        id="about"
        style={{ padding: "110px 28px", position: "relative", zIndex: 1 }}
      >
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          >
            ...
            >
              Software Engineering graduate passionate about building functional
            ...
            >
              <div
                style={{
                  ...
                  border: `1px solid ${T.cardBord}`,
                  boxShadow: D
                    ? "0 8px 40px rgba(0,0,0,.3),inset 0 1px 0 rgba(255,255,255,.03)"
                    : "0 8px 40px rgba(99,102,241,.1)",
                  backdropFilter: "blur(12px)",
                  marginBottom: "18px",
                }}
              >
                ...
                >
                  ...
                  <span
                    style={{ fontWeight: 700, fontSize: "14px", color: T.text }}
                  >
                ...
                {[
                  ...
                  [
                    Award,
                    "Graduated with an average final grade of 87.95",
                    "#fbbf24",
                  ],
                  [
                    Users,
                  ...
                  <div
                    ...
                    style={{
                      ...
                      borderBottom:
                        i < 3
                          ? `1px solid ${D ? "rgba(255,255,255,.04)" : "rgba(0,0,0,.05)"}`
                          : "none",
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                {[
                  ["Full-Stack Developer", Code, "#818cf8"],
                  ["UI/UX Designer", Palette, "#22d3ee"],
                  ["Graphic Designer", Paintbrush, "#f472b6"],
                ].map(([label, Icon, c], i) => (
                  <span
                    key={i}
                    className="stag"
                    style={{
                      ...
                      padding: "7px 16px",
                      borderRadius: "10px",
                      background: D ? `${c}12` : `${c}11`,
                      border: `1px solid ${c}25`,
                      fontSize: "12px",
                      fontWeight: 700,
                      color: c,
                      letterSpacing: ".03em",
                      animation: `tagSlide .4s cubic-bezier(.22,1,.36,1) ${0.1 * i}s both`,
                    }}
                  >
            ...
            >
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: "13px",
                      background: cert.bg,
                      border: `1px solid ${cert.accent}2a`,
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      flexShrink: 0,
                      boxShadow: `0 6px 20px ${cert.accent}1a`,
                    }}
                  >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div
                      className="mono lbl"
                      style={{ color: T.textFaint, fontSize: "9px" }}
                    >
              ...
              <div
                style={{
                  ...
                  borderRadius: "16px",
                  background: D
                    ? "linear-gradient(135deg,rgba(99,102,241,.08),rgba(6,182,212,.04))"
                    : "linear-gradient(135deg,rgba(99,102,241,.07),rgba(6,182,212,.05))",
                  border: `1px solid ${D ? "rgba(99,102,241,.12)" : "rgba(99,102,241,.15)"}`,
                }}
              >
                <p
                  style={{
                ...
                >
                  ...
                  while delivering clean architecture and seamless user
                  experiences.
                </p>
              </div>
            </div>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div className="sr" style={{ marginBottom: "56px" }}>
            <div
              className="pill"
              style={{
                background: D ? "rgba(34,211,238,.07)" : "rgba(6,182,212,.07)",
            ...
            {experiences.map((exp, idx) => (
              <TiltCard
                ...
                style={{
                  ...
                  border: `1px solid ${T.cardBord}`,
                  boxShadow: D
                    ? "0 8px 48px rgba(0,0,0,.3),inset 0 1px 0 rgba(255,255,255,.03)"
                    : "0 8px 48px rgba(99,102,241,.09)",
                  backdropFilter: "blur(12px)",
                }}
              >
                <div
                  className="topbar"
                  style={{ background: `linear-gradient(${exp.gradient})` }}
                />
                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          justifyContent: "center",
                          flexShrink: 0,
                          boxShadow: `0 8px 28px ${exp.accent}32`,
                        }}
                      >
                        ...
                        <span
                          ...
                          style={{
                            ...
                            background: D
                              ? "rgba(255,255,255,.03)"
                              : "rgba(0,0,0,.04)",
                            border: `1px solid ${D ? "rgba(255,255,255,.06)" : "rgba(0,0,0,.08)"}`,
                            fontSize: "11px",
                            color: T.textSub,
                            fontWeight: 500,
                          }}
          ...
          >
            <div>
              ...
              >
                Projects
                <br />
                <span style={{ color: "#f472b6", fontStyle: "italic" }}>
                  & Work
                </span>
              </h2>
            </div>
            ...
            >
              Recent projects built with care, clean architecture, and attention
              to detail.
            </p>
          </div>
            ...
            {projects.map((p, i) => (
              <TiltCard
                ...
                style={{
                  ...
                  border: `1px solid ${T.cardBord}`,
                  boxShadow: D
                    ? "0 4px 28px rgba(0,0,0,.26),inset 0 1px 0 rgba(255,255,255,.03)"
                    : "0 4px 28px rgba(99,102,241,.09)",
                  backdropFilter: "blur(10px)",
                  display: "flex",
                  flexDirection: "column",
                }}
              >
                ...
                >
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        justifyContent: "center",
                        boxShadow: `0 4px 16px ${p.accent}1c`,
                      }}
                    >
                      ...
                      <a
                        ...
                        style={{
                          ...
                          background: D
                            ? "rgba(255,255,255,.04)"
                            : "rgba(0,0,0,.04)",
                          border: `1px solid ${D ? "rgba(255,255,255,.07)" : "rgba(0,0,0,.07)"}`,
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                          textDecoration: "none",
                  ...
                  >
                    <Briefcase size={10} color={p.accent} />
                    {p.role}
                  </div>
                  <div
                        ...
                        <span
                          ...
                          style={{
                            ...
                            background: D
                              ? "rgba(255,255,255,.03)"
                              : "rgba(0,0,0,.04)",
                            border: `1px solid ${D ? "rgba(255,255,255,.055)" : "rgba(0,0,0,.07)"}`,
                            fontSize: "10px",
                            color: T.textSub,
                            fontWeight: 500,
                          }}
            ...
            <div className="sr sr-l">
              <div
                ...
                style={{
                  borderRadius: "18px",
                  overflow: "hidden",
                  border: `1px solid ${D ? "rgba(255,255,255,.07)" : "rgba(99,102,241,.13)"}`,
                  boxShadow: D
                    ? `0 32px 80px rgba(0,0,0,.6),0 0 80px ${cur.glow}18`
                    : "0 32px 80px rgba(99,102,241,.12)",
                }}
              >
                <div
                  style={{
                    background: D ? "#0c1118" : "#ddd9f5",
                    padding: "11px 16px",
                    display: "flex",
                    alignItems: "center",
                    gap: "12px",
                ...
                >
                  ...
                  >
                    <div
                      className="dot-pulse"
                      style={{
                        background: cur.link ? "#22c55e" : "#475569",
                        flexShrink: 0,
                        width: "5px",
                        height: "5px",
                      }}
                    ...
                    >
                      {cur.link
                        ? cur.link.replace("https://", "")
                        : `${cur.title.toLowerCase().replace(/\s+/g, "-")}.local`}
                    </span>
                  </div>
                  {cur.link && (
                    <a
                  ...
                  {cur.image ? (
                    ...
                    >
                      ...
                      <img
                        src={cur.image}
                        alt={cur.title}
                        className={D ? "img-dark" : "img-light"}
                        style={{
                          width: "100%",
                          height: "100%",
                          objectFit: "cover",
                      ...
                      <div
                        ...
                        onMouseEnter={(e) => {
                          ...
                          const h = e.currentTarget.querySelector(".zm");
                          if (h) {
                            h.style.opacity = "1";
                    ...
                    <div
                      style={{
                        width: "100%",
                        height: "100%",
                        background: "linear-gradient(135deg,#0c1118,#141b2d)",
                        display: "flex",
                        flexDirection: "column",
                        alignItems: "center",
                        justifyContent: "center",
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          height: "220px",
                          borderRadius: "50%",
                          background: `radial-gradient(circle,${cur.glow},transparent)`,
                          filter: "blur(40px)",
                          opacity: 0.55,
                        }}
                      />
                      <div
                        ...
                        style={{
                          ...
                          height: "66px",
                          borderRadius: "19px",
                          background: `linear-gradient(${cur.gradient})`,
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                          position: "relative",
                          zIndex: 1,
                          boxShadow: `0 16px 48px ${cur.glow}60`,
                        }}
                      >
                ...
                <button
                  ...
                  style={{
                    ...
                    background: D
                      ? "rgba(255,255,255,.04)"
                      : "rgba(99,102,241,.07)",
                    border: `1px solid ${D ? "rgba(255,255,255,.07)" : "rgba(99,102,241,.15)"}`,
                    color: T.textSub,
                    fontSize: "11px",
                    fontWeight: 700,
                    cursor: "pointer",
                ...
                >
                  {projectPreviews.map((_, i) => (
                    <button
                      ...
                      style={{
                        width: i === activePreview ? "26px" : "7px",
                        height: "7px",
                        borderRadius: "999px",
                        background:
                          i === activePreview
                            ? `linear-gradient(${projectPreviews[i].gradient})`
                            : D
                              ? "rgba(255,255,255,.12)"
                              : "rgba(99,102,241,.2)",
                        border: "none",
            ...
            >
              <TiltCard
                ...
                style={{
                  ...
                  border: `1px solid ${T.cardBord}`,
                  boxShadow: D
                    ? `0 0 60px ${cur.glow}12,0 8px 48px rgba(0,0,0,.28)`
                    : "0 8px 48px rgba(99,102,241,.1)",
              ...
              >
                ...
                >
                  <div
                    className="dot-pulse"
                    style={{ background: cur.tagColor }}
                  />
                  <span
                    className="mono lbl"
                    style={{ color: cur.tagColor, fontSize: "9.5px" }}
                  >
                    {cur.tag}
                  </span>
                </div>
                ...
                <div style={{ marginBottom: "16px" }}>
                  ...
                  >
                    <Briefcase size={12} color={cur.tagColor} />
                    {cur.role}
                  </div>
                </div>
                ...
                {cur.link && (
                  <a
                    ...
                    style={{
                      ...
                      fontWeight: 700,
                      textDecoration: "none",
                      boxShadow: `0 8px 28px ${cur.glow}35`,
                      letterSpacing: ".06em",
                      textTransform: "uppercase",
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = `0 14px 42px ${cur.glow}55`;
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = "translateY(0)";
                      e.currentTarget.style.boxShadow = `0 8px 28px ${cur.glow}35`;
                    }}
                  >
                    ...
                    >
                      <button
                        ...
                        style={{
                          ...
                          border:
                            i === activePreview
                              ? `2px solid ${p.tagColor}`
                              : `1px solid ${D ? "rgba(255,255,255,.07)" : "rgba(0,0,0,.09)"}`,
                          opacity: i === activePreview ? 1 : 0.42,
                          cursor: "pointer",
                          transition: "all .25s",
                          padding: 0,
                          ...
                          boxShadow:
                            i === activePreview
                              ? `0 0 14px ${p.tagColor}44`
                              : "none",
                        }}
                        onMouseEnter={(e) => {
                          if (i !== activePreview)
                            e.currentTarget.style.opacity = ".78";
                        }}
                        onMouseLeave={(e) => {
                          if (i !== activePreview)
                            e.currentTarget.style.opacity = ".42";
                        }}
                      >
                      ...
                      <p
                        style={{
                          fontSize: "8px",
                          fontWeight: 600,
                          color: i === activePreview ? p.tagColor : T.textFaint,
                          textAlign: "center",
                          letterSpacing: ".02em",
                          lineHeight: 1.2,
                          overflow: "hidden",
        ...
        >
          ...
          {[
            ...
            <button
              ...
              onClick={(e) => {
                ...
                setActivePreview(
                  (i) =>
                    (i + dir + projectPreviews.length) % projectPreviews.length,
                );
              }}
              style={{
                position: "absolute",
          ...
          <img
            ...
            style={{
              ...
              width: "100%",
              borderRadius: "18px",
              boxShadow: `0 40px 100px rgba(0,0,0,.75),0 0 0 1px rgba(255,255,255,.05),0 0 120px ${cur.glow}30`,
            }}
          />
          <p
            className="mono"
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div className="sr" style={{ marginBottom: "56px" }}>
            <div
              className="pill"
              style={{
                background: D ? "rgba(251,191,36,.07)" : "rgba(245,158,11,.07)",
            ...
            {[
              ...
              <TiltCard
                ...
                style={{
                  ...
                  border: `1px solid ${T.cardBord}`,
                  boxShadow: D
                    ? "0 4px 28px rgba(0,0,0,.24),inset 0 1px 0 rgba(255,255,255,.025)"
                    : "0 4px 28px rgba(99,102,241,.08)",
                  backdropFilter: "blur(10px)",
                }}
              >
                <div
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      border: `1px solid ${g.accent}24`,
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      boxShadow: `0 4px 16px ${g.accent}1a`,
                    }}
                  >
                    <g.icon size={17} color={g.accent} />
                  </div>
                  <span
                    style={{ fontWeight: 700, fontSize: "15px", color: T.text }}
                  >
                    {g.category}
                  </span>
                </div>
      ...
      <section
        id="contact"
        style={{ padding: "120px 28px", position: "relative", zIndex: 1 }}
      >
        <div className="divider-line" style={{ marginBottom: "80px" }} />
        <div
          style={{ maxWidth: "740px", margin: "0 auto", textAlign: "center" }}
        >
          <div
            className="pill"
            style={{
            ...
            {[
              {
                ...
                href: "mailto:maryanadh787@gmail.com",
                accent: "#f472b6",
              },
              {
                icon: Github,
                label: "GitHub",
                desc: "Check my code",
                href: "https://github.com/mryana23",
                accent: "#9f6fc7",
              },
              {
                icon: Linkedin,
                label: "Linkedin",
                desc: "Let's Connect",
                href: "https://www.linkedin.com/in/maryana-dwi-hendrianty-31b503328/",
                accent: "#22d3ee",
              },
            ].map((c, i) => (
              <a
              ...
              >
                <div
                  style={{
                    ...
                    justifyContent: "center",
                    margin: "0 auto 14px",
                    boxShadow: `0 4px 16px ${c.accent}18`,
                  }}
                >
          ...
          <button
            onClick={() =>
              (window.location.href = "mailto:maryanadh787@gmail.com")
            }
            className="btn-glow"
            style={{
              display: "inline-flex",
              ...
              cursor: "pointer",
              boxShadow:
                "0 12px 48px rgba(124,58,237,0.42), inset 0 1px 0 rgba(255,255,255,0.15)",
      ...
      <footer
        style={{
          borderTop: `1px solid ${D ? "rgba(99,102,241,0.07)" : "rgba(99,102,241,0.08)"}`,
          padding: "28px 28px",
          background: D ? "rgba(4,6,13,0.4)" : "rgba(248,247,255,0.5)",
          backdropFilter: "blur(12px)",
        }}
      >
        <div
        ...
        >
          ...
          <p
            className="mono label-text"
            style={{ color: T.textSub, fontSize: "9px" }}
          >
            Built with React · Designed with ✦ care
          </p>
          <div style={{ display: "flex", gap: "8px" }}>
            {[
              { icon: Github, href: "https://github.com/mryana23" },
              {
                icon: Linkedin,
                href: "https://www.linkedin.com/in/maryana-dwi-hendrianty-31b503328/",
              },
              { icon: Mail, href: "mailto:maryanadh787@gmail.com" },
              ...
              <a
                ...
                style={{
                  ...
                  border: `1px solid ${D ? "rgba(255,255,255,0.06)" : "rgba(99,102,241,0.1)"}`,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  color: T.textSub,
