...
import framory from "./assets/framory.png";
...
const projectPreviews = [
  ...
  { id:8, title:"Sumber Instrumindo", subtitle:"Corporate Website", period:"September 2025", tech:["Laravel","MySQL","Bootstrap","HTML+CSS+JS"], role:"Fullstack Developer", link:"https://sumberinstrumindo.com/", gradient:"135deg, #f97316, #ef4444", glow:"rgba(249,115,22,0.5)", image:sumber, placeholderIcon:Boxes, tag:"Live Website", tagColor:"#f97316" },
  { id:9, title:"Framory", subtitle:"Digital Photo Booth Platform", period:"March 2026", tech:["React","Tailwind CSS","Webcam API","Canva"], role:"Fullstack Developer", link:"#", gradient:"135deg, #ec4899, #818cf8", glow:"rgba(236,72,153,0.5)", image:framory, placeholderIcon:Camera, tag:"New Launch", tagColor:"#ec4899" },
];
...
export default function Portfolio() {
  ...
  const projects = [
    ...
    { title:"Framory Photobooth", period: "March 2025 ", description: "A full-stack digital photo booth platform featuring 4-shot burst capture, curated aesthetic themes, and instant high-resolution downloads with custom frames designed in Canva.", tech: ["React.js", "Tailwind CSS", "Webcam API", "Canva", "JavaScript"], role: "Fullstack Developer", icon: Camera, accent: "#ec4899", link:"https://framory-photo.vercel.app/"  },
